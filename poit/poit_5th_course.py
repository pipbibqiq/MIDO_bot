...
ikb_poit_5th_course.add(*ib_poit_1st_course_generalScheduleSheet)
ikb_poit_5th_course.add(*ib_poit_1st_course_sessionSchedule)
ikb_poit_5th_course.add(*ib_poit_1st_course_interSessionSchedule)
ikb_poit_5th_course.add(*ib_poit_1st_course_listOfTeachers)
ikb_poit_5th_course.add(*ib_poit_1st_course_liquidationOfDebts)
ikb_poit_5th_course.add(*ib_poit_1st_course_paymentSchedule)
